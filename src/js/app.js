...
// ここでは B3棟のオレンジのひし形の中心座標を基準にし、周辺の参考点も含めて範囲を決める。
const GPS_BUILDING_CENTER = { lat: 34.54538785923628, lng: 135.5048344623001 };
const GPS_CAMPUS_REFERENCE_POINTS = [
  { label: 'なかもず', lat: 34.555828844873616, lng: 135.50567766340524 },
  { label: '中百舌鳥', lat: 34.556341227195084, lng: 135.50420006469042 },
  { label: '白鷺', lat: 34.55014972949772, lng: 135.5133378462162 }
];
